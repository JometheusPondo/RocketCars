...
public class NetworkManager : NetworkBehaviour
{
  ...
  {
    if (!GlobalData.StartedThroughMainMenu) // accept all connections if not started through menu scene, this means the game was started in a map directly for testing reasons.
      return;
